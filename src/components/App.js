...
function App() {
    ...
    const [selectedCard, setSelectedCard] = React.useState({state:false});
    ...
    function handleCardClick(card) {
        setSelectedCard({state: true, name: card.name, link: card.link})
    }
  ...
  return (
    <div className='App'>
      <div className='page'>
        ...
        <PopupWithForm title={'Вы уверены ?'} name={'delete-picture'} buttonText={'Да'} children={<></>}/>
