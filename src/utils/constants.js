...
export const popupDeletePicture = document.querySelector(
	'#popup__deletePicture'
)
export const popupProfileAvatar = document.querySelector(
	'#popup__profileAvatar'
)
...
export const popupInputTextName = document.querySelector(
	'.popup__input_text_name'
)
export const popupInputTextDescription = document.querySelector(
	'.popup__input_text_description'
)
export const profileAddButton = document.querySelector('.profile__add-button')
export const elementsList = document.querySelector('.elements__list')
export const namePicture = document.querySelector('#popup__input_name_picture')
export const linkPicture = document.querySelector('#popup__input_link_picture')
export const popupSubmitButtonPicture = document.querySelector(
	'#popup__submit-button-picture'
)
